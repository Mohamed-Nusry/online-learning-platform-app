...
import { loadOneStudent, updateStudent } from "../../../library/store/student";
...
export default function EditStudentPage() {
  ...
  const editInfo = useSelector(state => state.student);
  ...
  useEffect(() => {
    if(editInfo.singleData != null) {
      ...
      formik.initialValues.first_name = editInfo.singleData.first_name;
      formik.initialValues.last_name = editInfo.singleData.last_name;
      formik.initialValues.username = editInfo.singleData.username;
      formik.initialValues.email = editInfo.singleData.email;
    }
  ...
  useEffect(() => {
    dispatch(loadOneStudent(params.id));
  },[])
